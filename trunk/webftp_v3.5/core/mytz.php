...
if (isset($_GET['act']) && $_GET['act'] == 'phpinfo'){
	...
	$mailReShow = 'show';
	$mailRe = 'MAIL邮件发送测试結果：';
	$mailRe .= (false !== @mail($_POST['mailReceiver'], 'MAIL SERVER TEST', "This email is sent by osdu.net.\r\n\r\osdu.net\r\nhttp://www.osdu.net"))?'<font color="green">发送成功</font>':'<font color="red">发送失败</font>';
...
<title>PHP探针 - Powered by osdu.net</title>
...
============================================================= -->
    ...
    <a name="top"></a>
    <p id="t12"><br />■ <a href="http://www.osdu.net/" target="_blank">点击下载 iPhpTZ 探针, 或查看最新版本 </a> ■<br /></p>
    <table width="100%" border="0" cellspacing="1" cellpadding="0" id="t3">
      ...
      <tr>
        <th colspan="7">
			...
			<b>〖项目网站〗</b>
				<a href="http://www.osdu.net/" target="_blank">Www.osdu.net</a>&nbsp;&nbsp;
				<a href="http://bbs.osdu.net/" target="_blank">Bbs.osdu.net</a>&nbsp;&nbsp;
		</th>
      </tr>
    </table>
EOT;
