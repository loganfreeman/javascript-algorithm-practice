...
<div id="header">
  <h1 id="logo"><a target="_blank" href="http://www.osdu.net/?webftp">WebFTP</a><i class="cline"></i><span>WebFTP</span></h1>
</div>
...
<div id="main">
  ...
  <div class="col-sub">
    <ul id="main-menu">
      <?php if('admin' == $_SESSION['uname']){;?><li id="help8"><span><i class="icon"></i><a target="_blank" href="./admin/">管理中心</a></span> </li><?php };?>
      <li id="help1"><span><i class="icon"></i><a href="javascript:void(0);" onclick="app.nfs.pathinfo();">目录详情</a></span> </li>
      <li id="help4"><span><i class="icon"></i><a href="javascript:void(0);" onclick="app.mui.thumb = !app.mui.thumb;" rel="imageStyle">图片预览</a></span> </li>
      <!-- <li id="help6"><span><i class="icon"></i><a href="javascript:void(0);" onclick="app.mui.resetpass();">修改密码</a></span> </li> -->
      <li id="help7"><span><i class="icon"></i><a href="javascript:void(0);" onclick="app.mui.logout();">安全退出</a></span> </li>
    </ul>
  </div>
  <div class="col-main">
    <div id="list">
...
<div id="footer">
    ...
    <a href="admin/mytz.php" target="_blank">系统环境</a> -
    <a href="javascript:alert('请联系QQ：858908467');">加入我们</a> -
    <a href="mailto:858908467@qq.com" target="_self">意见反馈</a><br/>
    CopyRight ©2011-2013 <a href="http://www.osdu.net/?webftp" target="_blank">OSDU.Net</a> All Rights Reserved.
</div>
