	...
	for($i=0; $i<$count; $i++) {
		...
		for ($ai=0; $ai<$dreamcount; $ai++) {
			...
			if(($found)){
				...
				$pf_l .= '<td width="'.(100/$lan).'%"><img src="i/dot.gif" /> <a href="'.($i+1).'.html">'.$detail[0].'</a></td>';
...
<tr><td align="left"><a href="http://www.5glive.com/">首页</a> &gt; <a href="../">实用工具集</a> &gt; <a href="./">民间验方</a><? if($prescription) echo ' &gt; 关于 <strong>'. $prescription.'</strong> 的验方'; ?></td><td align="right"><a href="javascript:;" onClick="window.external.AddFavorite(document.location.href,document.title);">收藏本页</a></td></tr></table>
<br>
<style type="text/css">
