...
WebFTP为 OSDU.Net 开发的PHP在线文件管理系统：
    系统采用Ajax+Json进行数据通信，毫秒级的响应速度；
    全平台兼容性：Win、Linux、Apache、Nginx、IIS；
    支持中英文目录名及文件名；
    强大的文件管理功能足以媲美专业的FTP软件；


## 请尽量不要使用第三方修改版本，放置被植入恶意代码
## 觉得程序好用的话请尽量购买商业版
## 觉得不好的话，勿喷，请立马删除程序

联系QQ: 858908467
联系E-mail: 858908467@qq.com


每一份坚持都值得被铭记！
WebFTP V3.5 功能变更及bug修正说明：
    1、精简前端页面结构，程序体积更小巧
    2、重构后端，更稳定、高效、安全
    3、更新上传组件，支持超大文件上传
