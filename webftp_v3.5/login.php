          ...
          <form method="post" id="myform" onSubmit="return check_submit(this);" action="login.php?act=login_check">
            ...
            <div class="input_div" style="margin-left:-60px;">
              ...
              <div style="padding:28px;">
                ...
                <input tabindex="1" type="text" size="30" name="uname" id="username" value="" class="input" onKeyDown="input_key_down(event)" onKeyUp="input_key_up(event,this,'username');" onFocus="heightlight(this.parentNode.parentNode)" onBlur="offlight(this.parentNode.parentNode)" />
              </div>
            </div>
            <div class="input_div" style="margin-left:193px;">
              ...
              <div style="padding:28px;">
                ...
                <input tabindex="2" type="password" name="upawd" size="30" id="password" value="" class="input" onKeyDown="input_key_down(event);input_key_up(event,this,'password');" onFocus="heightlight(this.parentNode.parentNode)" onBlur="offlight(this.parentNode.parentNode)"  style="font-family:Tahoma,Simsun,Helvetica,sans-serif;" />
              </div>
            </div>
            ...
            <input type="hidden" name="uhash" class="login_area_ckstr" id="uhash" value="<?php echo $uhash;?>" maxlength="4" />
          </form>
        </div></td>
    </tr>
    <tr>
