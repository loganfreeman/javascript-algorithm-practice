...
$(function () {
    ...
    app.api  = {
        ...
        path: '/?/', cover: 0,
        webftp_sessid: '<?php echo Session::id();?>',
        webftp_uname:  '<?php echo Cookie::get('uname');?>',
        webftp_tokey:  '<?php echo Cookie::get('tokey');?>'
    };

    app.settings = {
        max_file_size: '<?php echo C('UPLOAD.MAX_FILE_SIZE');?>', 
        chunk_size: '<?php echo C('UPLOAD.CHUNK_SIZE');?>',
        filters: []
    };
